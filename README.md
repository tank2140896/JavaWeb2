...
2、由于水平有限，本项目有很多不足和BUG，尤其是前端angular（正在考虑是否替换，所以目前仅做页面粗糙的展示下），所以本项目更新会比较频繁、改动会比较大，请见谅（更新代码时也请同步更新JavaWeb2-eureka-client-user/src/main/resources/sql/init.sql并重新cnpm install）         
