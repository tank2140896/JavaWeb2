...
public class ModuleControllerTest extends BaseControllerTest {
    ...
    public void testGetModuleIdAndNameList() throws Exception {
        String out = HttpUtil.defaultGetRequest(URL_PREFIX+"/web/sys/module/getModuleIdAndNameList/2",getHeaders());
	...
	public void testModuleDetail() throws Exception {
		String out = HttpUtil.defaultGetRequest(URL_PREFIX+"/web/sys/module/detail/20190707125317682",getHeaders());
		System.out.println(out);
	}
	
	@Test
	public void testModuleDelete() throws Exception {
		String out = HttpUtil.defaultDeleteRequest(URL_PREFIX+"/web/sys/module/delete/20190707125317682",null,getHeaders());
		System.out.println(out);
	}
