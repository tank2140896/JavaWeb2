...
public class SealUtil {
	...
	public static void main(String[] args) throws Exception {
		String name = "奉旨泡你";
		byte[] img = SealUtil.genSealData(name);
		byte2File(img,"E:/",name+".png");
	}
	...
	public static byte[] genSealData(String companyName) {
	...
	private static BufferedImage genSealImage(String companyName) {
	...
	private static void drwaHeadText(String companyName, Graphics2D g2d,
			int circleRadius) {
