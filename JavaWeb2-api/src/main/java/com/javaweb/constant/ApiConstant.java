...
public class ApiConstant {
	...
	public static final String GET_REQUESTID = "getRequestId";//获得请求ID
	public static final String GET_KAPTCHA = "/getKaptcha/{requestId}";//获得验证码
	...
	public static final String LOGIN_ACCESS_PREFIX = "/web/loginAccess";
	...
	public static final String MODULE_PREFIX = "/web/sys/module";
	...
	public static final String ROLE_PREFIX = "/web/sys/role";
	...
	public static final String USER_PREFIX = "/web/sys/user";
