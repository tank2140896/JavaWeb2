...
5、lombok最新版
二、项目依赖关系
JavaWeb2-eureka-client-user
                           -JavaWeb2-common
                           -JavaWeb2-database
                                             -JavaWeb2-common
因此，要正确完成JavaWeb2-eureka-server-1的编译需要先编译JavaWeb2-common再编译JavaWeb2-database
三、启动顺序
JavaWeb2-eureka-server-1
JavaWeb2-eureka-server-2
JavaWeb2-eureka-server-3
                        -JavaWeb2-eureka-client-user
四、使用前重要说明：
