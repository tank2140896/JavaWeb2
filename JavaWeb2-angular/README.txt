...
2、前端搬用项目：SB-Admin-BS4-Angular-5，项目地址：https://github.com/start-angular/SB-Admin-BS4-Angular-5
二、项目目前结构简述：
...
4.3、跨域参考：http://blog.csdn.net/qq_38321709/article/details/73867104
4.4、table参考：ng-treetable   
4.5、样式：NG-ZORRO    
